...
index 332006d7c6e258dce6b1f18c374f560d3fa9a96f..cf8e230a1f8f6c31338fcf06c3173c43f472d80e 100644
...
@@ -594,176 +597,437 @@ async function loadMyAuthContext() {
 ...
 function GuidesPanel({ isAdmin }) {
   ...
   async function load() {
     ...
     const { data, error } = await supabase
       .from("guides")
       .select("id, title, content, created_at")
@@ -952,308 +1216,50 @@ function AreasPanel({ isAdmin }) {
                   {isAdmin ? (
...
@@ -1386,51 +1392,50 @@ export default function Dashboard() {
...
@@ -1583,111 +1588,109 @@ const styles = {
