...
index 332006d7c6e258dce6b1f18c374f560d3fa9a96f..c1a54d3b9153d52a7d8217fc3574dab19a9c56cc 100644
...
@@ -594,276 +1009,732 @@ async function loadMyAuthContext() {
...
+        .from("guides")
+        .createSignedUrl(g.file_path, 60 * 30);
...
@@ -952,308 +1823,50 @@ function AreasPanel({ isAdmin }) {
                   {isAdmin ? (
...
@@ -1289,51 +1902,51 @@ function CalendarPanel() {
           </button>
         </div>
       </div>
...
@@ -1386,80 +1999,79 @@ export default function Dashboard() {
...
+      {activeTab === "guides" ? <GuidesPanel authUser={auth.user} isAdmin={auth.isAdmin} /> : null}
 ...
 const styles = {
   page: {
@@ -1583,123 +2195,123 @@ const styles = {
